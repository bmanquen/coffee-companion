...
- `coffees-create` saves a new Coffee from `/coffees/new`. Origin defaults to Single origin with one Country/Region pair. Blend keeps those fields and adds further countries (one region per country).
