...
reference recipe. Device-scoped Dialed-in is a different key: one Brew per user
...
and dashboard already mean "this Coffee's recipe." The new pointer is the
baseline for brewing on a given method and device.
